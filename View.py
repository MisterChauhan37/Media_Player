...
class view:
    def __init__(self, top=None):
        ...
        self.songName.place(relx=0.437, rely=0.038, height=44, width=381)
        ...
        self.songName.configure(text='''NO song is selected''')
    ...
    def load_next_song(self):
        if  self.sel_song_index_tuple[0]==self.playList.count()-1:
    ...
    def show_song_details(self):
        ...
        if(len(song_name_str) > 25):
            song_name_str=song_name_str[0:26]+"..."
    ...
    def load_songs_from_favourites(self):
        try:
            ...
            messagebox.showerror("DB Error!","sorry! songs can not be loaded from favoiurites!!!")
